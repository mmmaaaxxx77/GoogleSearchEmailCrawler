...
import { URL, STOCK_LIST, STOCK_SHAREHOLDER, STOCK_DETAIL, STOCK_COLLECTORCOUNT } from '../../config/Api';
        ...
        <GridItem xs={12}>
          <Card>
            <CardHeader color="primary" icon>
              ...
              <h4 className={classes.cardIconTitle}>集保戶股權每週差異</h4>
            </CardHeader>
            <CardBody>
              <ReactTable
                ...
                columns={[
                  ...
                  {
                    Header: "與前一周相差",
                    accessor: "data_difference_count"
                  },
                  {
                    Header: "日期",
                    accessor: "data_date",
                ...
                onFetchData={(state, instance) => {
                    ...
                    let url = URL + STOCK_COLLECTORCOUNT;
                        ...
                        self.setState({
                          data: res.data.data.map((prop, key) => {
                            return {
                              ...
                              stock_id: prop['stock_id'],
                              stock_name: prop['stock_name'],
                              data_date: prop['data_date'],
                              data_count: prop['data_count'],
                              data_difference_count: prop['data_difference_count']
                            }
                          }),
